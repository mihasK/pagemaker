...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Gadgets', fields ['webpage']
        db.delete_unique(u'pagemaker_gadgets', ['webpage_id'])


        # Changing field 'Gadgets.webpage'
        db.alter_column(u'pagemaker_gadgets', 'webpage_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pagemaker.WebPage']))

    def backwards(self, orm):

        # Changing field 'Gadgets.webpage'
        db.alter_column(u'pagemaker_gadgets', 'webpage_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['pagemaker.WebPage'], unique=True))
        # Adding unique constraint on 'Gadgets', fields ['webpage']
        db.create_unique(u'pagemaker_gadgets', ['webpage_id'])
