...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WebPage', fields ['slug']
        db.create_unique(u'pagemaker_webpage', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'WebPage', fields ['slug']
        db.delete_unique(u'pagemaker_webpage', ['slug'])
