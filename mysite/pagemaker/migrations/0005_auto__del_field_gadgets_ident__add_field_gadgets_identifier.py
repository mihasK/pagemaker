...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Gadgets.ident'
        db.delete_column(u'pagemaker_gadgets', 'ident')

        # Adding field 'Gadgets.identifier'
        db.add_column(u'pagemaker_gadgets', 'identifier',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Gadgets.ident'
        db.add_column(u'pagemaker_gadgets', 'ident',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Gadgets.identifier'
        db.delete_column(u'pagemaker_gadgets', 'identifier')
